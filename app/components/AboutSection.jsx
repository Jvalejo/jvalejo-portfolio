    ...
    <section className="relative bg-black border-t-2 border-zinc-800">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0">
        ...
        <div className="relative min-h-[400px] md:min-h-[700px] border-b md:border-b-0 md:border-r border-zinc-800 bg-black order-1 md:order-1 overflow-hidden group">
          ...
          <div 
            className="absolute top-6 md:top-8 left-6 md:left-8 w-10 md:w-12 h-10 md:h-12 z-10 pointer-events-none"
            style={{ border: '0.5px solid rgba(255,255,255,0.2)' }}
          />
          <div 
            className="absolute top-6 md:top-8 right-6 md:right-8 w-10 md:w-12 h-10 md:h-12 z-10 pointer-events-none"
            style={{ border: '0.5px solid rgba(255,255,255,0.2)' }}
          />
          <div 
            className="absolute bottom-6 md:bottom-8 left-6 md:left-8 w-10 md:w-12 h-10 md:h-12 z-10 pointer-events-none"
            style={{ border: '0.5px solid rgba(255,255,255,0.2)' }}
          />
          <div 
            className="absolute bottom-6 md:bottom-8 right-6 md:right-8 w-10 md:w-12 h-10 md:h-12 z-10 pointer-events-none"
            style={{ border: '0.5px solid rgba(255,255,255,0.2)' }}
          />
          
          {/* Frame Border */}
          <div 
            className="absolute inset-0 m-6 md:m-8 pointer-events-none z-10"
            style={{ border: '0.5px solid rgba(255,255,255,0.2)' }}
          />
        </div>
